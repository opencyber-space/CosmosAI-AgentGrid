...
class LocalToolExecutor:
    ...
    def initialize_function(self):
        try:
            ...
            self.function_class = getattr(module, "AgentSpaceV1Tool")(
                self.tool_id,
                self.tool_data
            )
    ...
    def execute_command(self, command_name: str, data: dict):
        logging.info(f"[Management Command] {command_name}: {data}")
        self.function_class.execute_command(command_name, data)
    ...
    def evaluate(self, input_data):
        try:
            ...
            return self.function_class.execute(input_data)
        except Exception as e:
