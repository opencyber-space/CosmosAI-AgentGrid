...
envsubst < "./agent_router_simple_workflow_router_agent.json" > "./agent_router_simple_workflow_router_agent_evaluated.json"
curl -X POST \
    -H "Content-Type: application/json" \
    -d @"./agent_router_simple_workflow_router_agent_evaluated.json" \
    ${API_BASE_URL}/api/subjects
rm -f "./agent_router_simple_workflow_router_agent_evaluated.json"