...
class ContentSignature(dspy.Signature):
    ...
    ### TASK
    Generate product messaging and sample campaign text based on the problem statement.
    ### OUTPUT
    ...
    output_data = dspy.OutputField(desc="""Valid JSON block: {"messaging": "string", "campaign_text": "string", "deliverables": ["string"]}""")

class ContentModule(dspy.Module):
    def __init__(self, system_prompt):
        super().__init__()
        self.worker = dspy.ChainOfThought(ContentSignature)
...
class MarketingContentAgent:
    def __init__(self, subject, context: Context) -> None:
        ...
        self.module = ContentModule(self.persona_default_system_message)
