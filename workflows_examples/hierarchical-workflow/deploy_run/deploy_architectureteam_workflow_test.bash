...
-d '
{
    "deployment_name": "workflow-architecture-team",
    "workflow_id": "workflow-architecture-team",
    "workflow_uri": "workflow-architecture-team:1.0.0-production",
    "allocation": {
...
'
echo -e "\nArchitecture sub-workflow deployed successfully!"
