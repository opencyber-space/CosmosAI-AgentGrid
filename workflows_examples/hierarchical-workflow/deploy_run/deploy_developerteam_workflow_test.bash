...
-d '
{
    "deployment_name": "workflow-developer-team",
    "workflow_id": "workflow-developer-team",
    "workflow_uri": "workflow-developer-team:1.0.0-production",
    "allocation": {
...
'
echo -e "\nDeveloper sub-workflow deployed successfully!"
