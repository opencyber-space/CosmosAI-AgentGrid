...
-d '
{
    "deployment_name": "workflow-testing-team",
    "workflow_id": "workflow-testing-team",
    "workflow_uri": "workflow-testing-team:1.0.0-production",
    "allocation": {
...
'
echo -e "\nTesting sub-workflow deployed successfully!"
