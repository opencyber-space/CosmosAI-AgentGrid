...
-d '
{
    "deployment_name": "workflow-marketing-team",
    "workflow_id": "workflow-marketing-team",
    "workflow_uri": "workflow-marketing-team:1.0.0-production",
    "allocation": {
...
'
echo -e "\nMarketing sub-workflow deployed successfully!"
